...
import 'package:videoplayerdemo/video.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Future<void> _pickVideo() async {
    ...
    if (response is OnSuccess) {
      ...
      setState(() async {print("Successfully");
        _desFile = response.destinationPath;
        _displayedFile = _desFile;
        print("++++++++++++${_displayedFile}");
        final compressedfile = File(_displayedFile ?? "");
  ...
  Navigator.push(context, MaterialPageRoute(builder: (context) {
    return BumbleBeeRemoteVideo(videoFile: compressedfile);
  },));
